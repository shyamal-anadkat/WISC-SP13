...
LD	r0, r1, 0		//read from address			pc = 4
ST	r0, r2, 0		//store to address: hit, make dirty	pc = 6
//load value 2084= 0x824: maps to same cache line
//first load 0x08
LBI	r3, 8			//					pc = 8
//then load 0x24
SLBI	r3, 36			//					pc = a
LD	r3, r2, 0		//read from address that evicts addr32	pc = e
LD	r0, r1, 0		//read from addr 32			pc = 10
...
LD	r0, r1, 0		//read from address			pc = 16
ST	r0, r2, 0		//store to address: hit, make dirty	pc = 18
//load value 2132= 0x854 maps to same cache line
//first load 0x08
LBI	r3, 8			//					pc = 1a
//then load 0x54
SLBI	r3, 84			//					pc = 1e
LD	r3, r2, 0		//read from address that evicts addr80	pc = 20
LD	r0, r1, 0		//read from addr 80			pc = 22
...
SLBI	r0, 32			//					pc = 26
LD	r0, r3, 0		//read from addr 288			pc = 28
LD	r0, r3, 2		//read from addr 290 (hit)		pc = 2a
LD	r0, r3, 8		//read from addr 296 (miss)		pc = 2c
...
SLBI	r0, 70			//					pc = 30
LD	r0, r3, 0		//read from addr 838			pc = 32
LD	r0, r3, -6		//read from addr 832 (hit)		pc = 34
LD	r0, r3, 8		//read from addr 840 (miss)		pc = 36
...
SLBI	r0, 102			//					pc = 3a
LD	r0, r3, 0		//read from addr 1382			pc = 3c
LD	r0, r3, 2		//read from addr 1384 (miss)		pc = 3e
LD	r0, r3, -2		//read from addr 1380 (miss)		pc = 40
LD	r0, r3, 8		//read from addr 1390 (hit from 1384)	pc = 42
...
LD	r0, r1, 0		//read from address			pc = 4a
ST	r3, r2, 0		//store to address: miss		pc = 4c
//load value 2084= 0x824: maps to same cache line
//first load 0x08
LBI	r3, 8			//					pc = 4e
//then load 0x24
SLBI	r3, 36			//					pc = 50
LD	r3, r2, 0		//read from address that evicts addr32	pc = 52
LD	r0, r1, 0		//read from addr 32			pc = 54
